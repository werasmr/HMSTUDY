    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-100">PrismaPay</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-bg-card rounded-xl border border-gray-700 p-6 space-y-4">
          ...
          <Input
            ...
            placeholder="trader@prismapay.com"
            required
          />
        ...
        <div className="mt-4 p-4 bg-bg-card/50 rounded-lg border border-gray-800 text-xs text-gray-500 space-y-1">
          ...
          <p>Trader: trader@prismapay.com / password123</p>
          <p>Merchant: merchant@prismapay.com / password123</p>
          <p>Admin: admin@prismapay.com / password123</p>
        </div>
      </div>
    </div>
  );
